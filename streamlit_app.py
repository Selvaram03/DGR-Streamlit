...
# --- Sidebar Controls ---
with st.sidebar:
    st.image("enrich_logo.png", use_container_width=True)  # replace with your logo path
...
# Show irradiation metrics if available
...
with pd.ExcelWriter(output_file, engine="openpyxl") as writer:
    # Sheet 1: Inverter-wise Generation
    ...
    summary_data = {
        ...
        "Value": [
            customer,
            safe_day_str,
            round(total_daily_gen, 2),
            round(total_monthly_gen, 2),
            round(plf_percent, 2),
        ],
    }
